...
import com.spring.config.AppCtx;
import com.spring.java.ChangePasswordService;
import com.spring.java.DuplicateMemberException;
import com.spring.java.MemberInfoPrinter;
import com.spring.java.MemberListPrinter;
import com.spring.java.MemberNotFoundException;
import com.spring.java.MemberRegisterService;
import com.spring.java.RegisterRequest;
import com.spring.java.VersionPrinter;
import com.spring.java.WrongIdPasswordException;
	...
	public static void main(String[] args) throws IOException{
		...
		while(true) {
			...
			if(command.startsWith("new ")) {
				processNewCommand(command.split(" ")); // split된 배열 전달
				continue;
			}
